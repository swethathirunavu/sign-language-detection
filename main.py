...
if camera_input:
    ...
    if len(posList) != 0:
        # Process gestures as per the original code
        ...
        # Show the image with the gesture result
        st.image(img, channels="BGR", caption="Hand Gesture Recognition", use_column_width=True)
        st.write(f"Detected Gesture: {result}")
else:
